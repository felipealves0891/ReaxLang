...
public interface IReaxExecutionContext
{
    ...
    void DeclareImmutable(string identifier, LiteralNode node);
    void Declare(string identifier);
    void SetVariable(string identifier, LiteralNode value);
    ...
    LiteralNode GetVariable(string identifier);
    LiteralNode? GetBind(string identifier);
