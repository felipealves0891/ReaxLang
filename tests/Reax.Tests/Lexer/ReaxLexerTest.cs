    ...
    public static IEnumerable<object[]> Tokenize_HappyWay_Data 
    {
        get
        {
            return [
                ...
                ["console.writer(minha_variavel);", new TokenType[] {TokenType.IDENTIFIER, TokenType.ACCESS, TokenType.IDENTIFIER, TokenType.START_PARAMETER, TokenType.IDENTIFIER, TokenType.END_PARAMETER, TokenType.END_EXPRESSION, TokenType.EOF}],
                ...
                ["fun eMenorQueZero(num: int):bool {}", new TokenType[] {TokenType.FUNCTION, TokenType.IDENTIFIER, TokenType.START_PARAMETER, TokenType.IDENTIFIER, TokenType.TYPING, TokenType.INT_TYPE, TokenType.END_PARAMETER, TokenType.TYPING, TokenType.BOOLEAN_TYPE, TokenType.START_BLOCK, TokenType.END_BLOCK, TokenType.EOF}],
