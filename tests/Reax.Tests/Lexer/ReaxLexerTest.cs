    ...
    public static IEnumerable<object[]> Tokenize_HappyWay_Data 
    {
        get
        {
            return [
                ...
                ["bind meuNumeroVezes2: float -> meuNumero * 2;", new TokenType[] {TokenType.BIND, TokenType.IDENTIFIER, TokenType.COLON, TokenType.NUMBER_TYPE, TokenType.ARROW, TokenType.IDENTIFIER, TokenType.FACTOR, TokenType.NUMBER_LITERAL, TokenType.SEMICOLON, TokenType.EOF}],
                ...
                ["let minhaDivisao: int;", new TokenType[] {TokenType.LET, TokenType.IDENTIFIER, TokenType.COLON, TokenType.NUMBER_TYPE, TokenType.SEMICOLON, TokenType.EOF}],
                ["for controle: int = 0 to 100 {}", new TokenType[] {TokenType.FOR, TokenType.IDENTIFIER, TokenType.COLON, TokenType.NUMBER_TYPE, TokenType.ASSIGNMENT, TokenType.NUMBER_LITERAL, TokenType.TO, TokenType.NUMBER_LITERAL, TokenType.OPEN_BRACE, TokenType.CLOSE_BRACE, TokenType.EOF}],
                ...
                ["fun eMenorQueZero(num: int):bool | string {}", new TokenType[] {TokenType.FUNCTION, TokenType.IDENTIFIER, TokenType.OPEN_PARENTHESIS, TokenType.IDENTIFIER, TokenType.COLON, TokenType.NUMBER_TYPE, TokenType.CLOSE_PARENTHESIS, TokenType.COLON, TokenType.BOOLEAN_TYPE, TokenType.PIPE, TokenType.STRING_TYPE, TokenType.OPEN_BRACE, TokenType.CLOSE_BRACE, TokenType.EOF}],
                ...
                ["for controle: int in [0]", new TokenType[] {TokenType.FOR, TokenType.IDENTIFIER, TokenType.COLON, TokenType.NUMBER_TYPE, TokenType.IN, TokenType.OPEN_BRACKET, TokenType.NUMBER_LITERAL, TokenType.CLOSE_BRACKET, TokenType.EOF}],
